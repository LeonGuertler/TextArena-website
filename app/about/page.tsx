...
//         <h2 className="text-2xl font-semibold mb-4">Our Sponsors</h2>
//         <p className="mb-4">
//           We are incredibly grateful for the support of our sponsors. Their
//           generosity and belief in our mission have been instrumental in
//           bringing TextArena to life. We extend our heartfelt thanks to Google,
//           Anthropic, AWS, and OpenRouter for their invaluable contributions.
//         </p>
//         <p className="mb-6">
//           If you're interested in supporting our project, please don't hesitate
...
//             guertlerlo@cfar.a-star.edu.sg
//           </Link>
//           . Your support can help us continue to innovate and expand the
//           possibilities of AI-powered text adventures.
//         </p>
//         <div className="flex flex-wrap justify-center gap-8 mb-8">
//           {sponsors.map((sponsor) => (
//             <div key={sponsor.name} className="relative group inline-block p-8">
...
//               <div
//                 className="absolute left-1/2 -translate-x-1/2 mt-2 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity"
//                 style={{
...
//         <p>
//           We would also like to thank our other contributors: <br />
//           <span className="font-medium">Gabriel Chua</span>,{" "}
//           <span className="font-medium">Romir Patel</span>,{" "}
//           <span className="font-medium">Dylan Hillier</span>.
//         </p>
//       </section>
//     </div>
//   );
