    ...
    <div className="flex flex-col h-screen relative">
      ...
      {connectionLost && (
        <div className="absolute inset-0 bg-background/80 flex items-center justify-center z-40">
          <div className="bg-navbar p-6 rounded-md shadow-lg w-full max-w-sm text-navbarForeground text-center">
            ...
            <Button onClick={handleConnectionLostClose} className="mx-auto bg-background hover:bg-muted text-foreground">
              Close
            </Button>
          </div>
        </div>
