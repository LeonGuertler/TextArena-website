...
export function WelcomeDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      {/* Adding font-mono here makes the entire dialog (message and button) use the monospaced font */}
      <DialogContent className="sm:max-w-md font-mono">
        ...
        <DialogFooter className="flex justify-center sm:justify-center">
          {/* The button will inherit the monospaced font from its parent, but you can also add font-mono directly if needed */}
          <Button
            type="button"
            variant="default"
            onClick={() => setOpen(false)}
